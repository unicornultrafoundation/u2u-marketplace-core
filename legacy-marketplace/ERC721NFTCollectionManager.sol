...
contract ERC721NFTCollectionManager is Ownable {
    ...
    constructor(address _recipient, uint256 _feePercent) Ownable(_recipient) {
    ...
    function newCollection (
        ...
        require(IERC721(_collection).supportsInterface(0x80ac58cd), "New collection: Not ERC721");
